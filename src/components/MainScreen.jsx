const MainScreen = (props) => {
  ...
  return (
    ...
    <div style={{width: 1200, height: 600, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 2, color: 'white', backgroundColor: 'black'}}>
        ...
        <h2 style={{color: 'white', textAlign: 'center', width: 500}}>Answer the questions and escape from the castle infected with zombies that will kill you if you answer wrong!</h2>
